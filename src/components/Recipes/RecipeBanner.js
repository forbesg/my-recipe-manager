...
function RecipeBanner (props) {
  ...
  let image = require(`../../images/flags/${flagCode}.svg`);
  let recipeImage = props.recipe.imageURL ? (
  ...
  return (
    <div className="recipe-banner">
      ...
      <div className="recipe-info">
        ...
        <p>Prep <i className="fa fa-clock-o" aria-hidden="true"></i> : {props.recipe.prepTime} minutes</p>
        <p>Cook <i className="fa fa-clock-o" aria-hidden="true"></i> : {props.recipe.cookTime} minutes</p>
